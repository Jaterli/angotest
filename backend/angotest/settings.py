...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'angotest_user'),
...
# settings.py (entorno desarrollo)
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            ...
            'level': 'DEBUG',  # Mostrar todo en consola
        },
    },
    'root': {
        'handlers': ['console'],
        'level': 'DEBUG',  # Nivel raíz
    },
    'loggers': {
        'apps.users': {
            'handlers': ['console'],
...
if os.getenv('ENV') == 'production':
    ...
    CACHES = {
        'default': {
            ...
            'PICKLE_VERSION': -1,
            'IGNORE_EXCEPTIONS': True,  # No falla si Redis no está disponible            
        }
    }
else :
    CACHES = {
